...
const displayInfos = async () => {
  ...
  // Parar animação após carregar os jogos
  const animatedElement = document.querySelector("#anim"); // Selecione o elemento animado
  if (animatedElement) {
    animatedElement.classList.add("stop-animation");
  }
